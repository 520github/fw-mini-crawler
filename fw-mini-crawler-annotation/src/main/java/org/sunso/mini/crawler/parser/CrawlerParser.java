 ...
 * @Title:CrawlerParser
 * @Description: 爬虫解析器
 * 根据下载器返回的结果CrawlerHttpResponse，以及CrawlerResult字段定义，解析字段，设置字段值
...
public interface CrawlerParser {
     ...
     *
     * <p>CrawlerResult类例子<p/>
     *
     * @Data
     * @CrawlerResultDefine(handlers = {ConsoleCrawlerHandler.class})
     * public class NotifyCrawlerResult implements CrawlerResult {
     *     @HtmlCssPath(".container .details_page > h2 > p")
     *     @HtmlText
     *     private String title;
     *
     *     @HtmlHtml
     *     @HtmlCssPath("div#div_zhengwen")
