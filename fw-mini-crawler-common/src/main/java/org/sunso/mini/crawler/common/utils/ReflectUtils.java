...
public class ReflectUtils {
	...
	public static boolean isAnnotationPresentRecursion(Class<? extends Annotation> targetClass,
	...
	public static <T extends Annotation> T getAnnotationRecursion(Class<? extends Annotation> targetClass,
