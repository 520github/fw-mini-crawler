...
public class HutoolCrawlerDownloaderTest extends BaseTest {
	...
	public void getHeaderAndCookiesTest() {
		int page = 1;
		String url = "http://www.zhongzhenglawyer.com/index.php?c=Front/LoadModulePageData&PageNo=" + page
				+ "&ClassID=0&responseModuleId=420292825";
