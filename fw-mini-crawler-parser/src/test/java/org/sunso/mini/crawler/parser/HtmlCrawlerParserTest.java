...
public class HtmlCrawlerParserTest extends BaseTest {
	...
	public void parseTest() {
		// DemoCrawlerResult result =
		// (DemoCrawlerResult)unionCrawlerParser.parse(DemoCrawlerResult.class,
		// getRequest(), getResponse());

		GithubCrawlerResult result = (GithubCrawlerResult) unionCrawlerParser.parse(GithubCrawlerResult.class,
				getRequest(), getResponse());
