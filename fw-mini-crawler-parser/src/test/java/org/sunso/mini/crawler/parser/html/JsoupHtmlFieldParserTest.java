...
public class JsoupHtmlFieldParserTest extends BaseTest {
	...
	private String html() {
		...
		// return "<tr
		// title=\"本次发行的可转债向发行人在股权登记日(2023年11月14日,T-1日)收市后中国结算上海分公司登记在册的原股东优先配售,原股东优先配售后余额部分(含原股东放弃优先配售部分)采用网上通过上交所交易系统向社会公众投资者发售的方式进行,余额由保荐人(主承销商)包销。\"
		// data-index=\"0\">\n" +
		// " <td id='kkk' style=\"width: 60px; \">113680</td>\n" +
		// " <td style=\"width: 60px; \">丽岛转债</td>\n" +
		// " <td style=\"width: 60px; \"><a class=\"red\"
		// href=\"/kzz/detail/113680.html\">详细</a>&nbsp;<a
		// href=\"//guba.eastmoney.com/list,sh113680.html\">股吧</a></td>\n" +
		...
		// href=\"//quote.eastmoney.com/unify/r/1.603937\">603937</a></td>\n" +
		// " <td style=\"width: 60px; \"><a href=\"/stockdata/603937.html\"><span
		// title=\"丽岛新材\">丽岛新材</span></a></td>\n" +
		...
		// "</tr>, code=null), ConvertibleBondsDataCrawlerResult(body=<tr
		// title=\"本次发行的可转换公司债券向发行人在股权登记日(2023年11月8日,T-1日)收市后中国结算深圳分公司登记在册的原股东优先配售,原股东优先配售后余额部分(含原股东放弃优先配售部分)通过深交所交易系统向社会公众投资者发行,余额由保荐人(主承销商)包销。\"
		// data-index=\"1\">\n" +
		// " <td style=\"width: 60px; \">123231</td>\n" +
		// " <td style=\"width: 60px; \">信测转债</td>\n" +
		// " <td style=\"width: 60px; \"><a class=\"red\"
		// href=\"/kzz/detail/123231.html\">详细</a>&nbsp;<a
		// href=\"//guba.eastmoney.com/list,sz123231.html\">股吧</a></td>\n" +
		// " <td class=\"nowrap desc_col\" style=\"width: 110px; \">2023-11-09 周四</td>\n"
		// +
		// " <td style=\"width: 60px; \">370938</td>\n" +
		// " <td style=\"width: 70px; \">100</td>\n" +
		// " <td style=\"width: 60px; \"><a
		// href=\"//quote.eastmoney.com/unify/r/0.300938\">300938</a></td>\n" +
		// " <td style=\"width: 60px; \"><a href=\"/stockdata/300938.html\"><span
		// title=\"信测标准\">信测标准</span></a></td>\n" +
