...
public class UnionCrawlerParserAjaxJsonTest extends AbstractHtmlCrawlerParser {
    ...
    class AjaxJsonResult implements CrawlerResult {
        @JsonPath("data.total")
        @HtmlAjax(url = "https://dev-cqb.lddstp.com/zz-official/article/info/page/list", method = HttpRequestMethodEnum.POST, contentType = ContentTypeEnum.applicationJson ,downloader = HutoolCrawlerDownloader.class)
        Integer count;
