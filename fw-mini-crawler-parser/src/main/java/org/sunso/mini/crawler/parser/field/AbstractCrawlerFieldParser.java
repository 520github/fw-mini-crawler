...
public abstract class AbstractCrawlerFieldParser implements CrawlerFieldParser {
	 ...
	 * <p/>
	 * <ul>
	 * <li>@JsonPath(value = "data.list", expressionFilter = "viewNumList>0 &&
	 * viewNumList<=5")</li>
	 * </ul>
	 * @param field 字段
	...
	protected CrawlerFieldParserRequest newCrawlerFieldParserRequest(CrawlerFieldParserRequest request,
